...
```sh
npm install -D 'github:fehnomenal/sveltekit-gen-routes#semver:v4.1.4'
```

```sh
yarn install -D 'github:fehnomenal/sveltekit-gen-routes#semver:v4.1.4'
```

```sh
pnpm install -D 'github:fehnomenal/sveltekit-gen-routes#semver:v4.1.4'
```

```sh
bun add -D 'github:fehnomenal/sveltekit-gen-routes#v4.1.4'
```
